...
/* FFmpeg version hash */
#define FFMPEG_VER_SHA "2.8.6-Jarvis-16.0"
...
/* Define to 1 if `audio_remote_control_id' is a member of `struct
   raop_callbacks_s'. */
#define HAVE_STRUCT_RAOP_CALLBACKS_S_AUDIO_REMOTE_CONTROL_ID 1
...
#define HAVE_VIDEOTOOLBOXDECODER 1
...
#define HAVE_YAJL_YAJL_COMMON_H 1
...
#define PACKAGE_STRING "kodi 16.1.000"
...
#define PACKAGE_VERSION "16.1.000"
...
/* #undef USE_STATIC_FFMPEG */

/* Define to 1 to enable UPnP support. */
#define USE_UPNP 1

/* Version number of package */
#define VERSION "16.1.000"
