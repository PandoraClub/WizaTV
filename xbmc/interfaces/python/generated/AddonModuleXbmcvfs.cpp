...
namespace PythonBindings
{
  ...
  static PyObject* xbmcvfs_XBMCAddon_xbmcvfs_File_New (PyTypeObject* pytype  , PyObject *args, PyObject *kwds  )
  {
    ...
    try
    {
      if (pyfilepath) PyXBMCGetUnicodeString(filepath,pyfilepath,false,"filepath","XBMCAddon::xbmcvfs::File"); 
  ...
  static PyObject* xbmcvfs_XBMCAddon_xbmcvfs_Stat_New (PyTypeObject* pytype  , PyObject *args, PyObject *kwds  )
  {
    ...
    try
    {
      if (pypath) PyXBMCGetUnicodeString(path,pypath,false,"path","XBMCAddon::xbmcvfs::Stat"); 
  ...
  void initModule_xbmcvfs()
  {
   ...
   PyModule_AddStringConstant(module, (char*)"__date__", (char*)"Tue Jan 31 17:14:34 IST 2017");
